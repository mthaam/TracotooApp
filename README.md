...
Cette politique de confidentialité porte sur :
-	Les informations importantes et la description de l’Éditeur de l’application Tracotoo.
-	Principes relatifs à la collecte et au traitement des données personnelles.
-	Quels utilisateurs sont concernés par la collecte de données.
-	Les données personnelles que l’application collecte.
-	La manière dont sont collectées les données personnelles des utilisateurs. Sont considérées comme données personnelles, toute information permettant d’identifier un utilisateur. À ce titre, il peut s’agir : de ses noms et prénoms, d’un éventuel pseudonyme ou nom d’utilisateur, de son adresse e-mail, de sa localisation, de l’adresse IP.
-	Les éventuels destinataires de ces données personnelles.
-	La politique de l’application en matière de cookies et traceurs.
-	La durée de conservation des données.
-	Sur les droits dont disposent les utilisateurs concernant ces données.
...
Informations importantes et description de l’Éditeur de l’application Tracotoo
...
L’éditeur de l’application est le contrôleur et le responsable des données personnelles que l’utilisateur final peut être amené à divulguer via l’application.
...
Les utilisateurs qui choisissent de ne pas créer de compte et de sauvegarder les données renseignées dans leur terminal, sont également concernés par la collecte de données, mais uniquement pour le calcul des empreintes carbone, et ce de façon anonyme.

Les utilisateurs finaux qui font usage de Tracotoo avec un compte, sont également concernés par la collecte de données pour le calcul des empreintes carbone. 
...
-	Mot de passe
-	Adresse IP
La fonctionnalité d’inscription et de connexion à l’application pour les utilisateurs disposant d’un compte, utilise ces données pour activer l’utilisateur final et faciliter la gestion du compte de l’utilisateur final. Ces fonctionnalités utilisent également des chaînes de caractères d’agent utilisateur (également appelées User Agent Strings) pour fournir une sécurité supplémentaire et empêcher les abus lors de l’inscription et de l’authentification.

Si l’utilisateur disposant d’un compte choisit de sauvegarder le calcul de l’empreinte carbone d’un trajet, les données collectées sont :
-	L’identifiant de l’utilisateur
-	Les adresses et coordonnées GPS des adresses de départ et d’arrivée
-	La distance du trajet
-	Véhicule utilisé (Marque, Modèle, Année, Motorisation)

Les utilisateurs disposant d’un compte et sauvegardant des empreintes carbone généreront également sur un serveur distant des données récapitulant les totaux des empreintes carbone, de façon mensuelle et annuelle, pour les mois et / ou années où l’utilisateur enregistre des trajets.
Pour tous les utilisateurs :
Pour procéder aux calculs d’empreinte carbone, l’application enverra sur un serveur distant les données suivantes :
-	Distance du trajet
-	Véhicule utilisé (Marque, Modèle, Année, Motorisation)
Les données collectées pour procéder aux calculs d’empreinte carbone sont anonymisées, il est par conséquent impossible de relier l’utilisateur final aux données.
...
Par courrier à l’adresse :  76 AVENUE FOCH 94100 ST MAUR DES FOSSÉS ;  
